...
Ext.define('Ext.ux.upload.Dialog', {
    ...
    alias: 'widget.newprojectpanel',
    id: 'newProjectGridPanel',
    ...
    config : {
        ...
        textOk : 'OK',
        textClose : 'Close',
        textUpload : 'Submit for processing',
        textBrowse : 'Add Files in the Batch',
        textAbort : 'Abort',
        textRemoveSelected : 'Remove selected',
        textRemoveAll : 'Remove all',

        // grid strings
        textFilename : '<b>FILE NAME</b>',
        textSize : '<b>SIZE</b>',
        textType : '<b>TYPE</b>',
        textStatus : '<b>STATUS</b>',
        textProgress : '<b>%</b>',
